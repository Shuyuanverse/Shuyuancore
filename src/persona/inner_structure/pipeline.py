...
class InnerStructureResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """转换为字典"""
        return {
            "self_review_result": self.self_review_result.to_dict()
            if self.self_review_result
            else None,
...
class InnerStructurePipeline:
    ...
    def _get_suggestion_for_dimension(
        ...
        suggestion_map = {
            ...
            "voice_fidelity": ("保持风格一致性，避免偏离锚定风格，回顾人格画像中的风格维度定义"),
        }
